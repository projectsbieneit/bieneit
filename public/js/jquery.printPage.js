...
(function( $ ){
  $.fn.printPage = function(options) {
    ...
    var components = {
      iframe: function(url){
        return '<iframe id="printPage" name="printPage" src='+url+' style="top:0px; left:0px;width:0px; height:0px;border:0px;overfow:none; color:#000;"><style>.topbar{display:none;}.left-sidebar{display:none !important;}</style></iframe>';
      },
      messageBox: function(message){
        return "<div id='printMessageBox' style='\
          ...
          color:#000;\
          width:310px; height:120px; font-size:12px; padding:10px; color:#222; font-family:helvetica, arial;\
