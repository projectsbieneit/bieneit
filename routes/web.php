...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/tkm/delete/{id}', 'TkmOrdersController@destroy');
    Route::get('/tkm/update/{id}', 'TkmOrdersController@edit');
    Route::post('/tkm/updateit/{id}', 'TkmOrdersController@update');
